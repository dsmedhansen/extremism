...
class YoutubeFollower():
    ...
    def get_search_results(self, search_terms, max_results, top_rated=False):
        ...
        html = urllib2.urlopen(url_request, context=gcontext)
...
def main():
    ...
    compare_keywords(query, searches, branch, depth, name, None, None, False, False)
